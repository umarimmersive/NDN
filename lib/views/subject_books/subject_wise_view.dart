...
class SubjectWiseView extends GetView<subject_wise_view_controller> {
              ...
              children: [
                ...
                Expanded(
                  child: GridView(
                    ...
                    :
                Expanded(child: Center(child: Text('Data not found',style: TextStyle(color: ColorValues.BLACK)),)):
